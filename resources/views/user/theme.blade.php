 	...
 	<div class="col-md-12">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse1">
          ...
          <ul class="nav navbar-nav navbar-right">
             <li><a href="#" target="_ext">Bootply+</a></li>
             <li class="">
   ...
   <div class="col-sm-6 col-md-4">
        ...
        <div class="panel panel-default">
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>More Templates</h4></div>
   			<div class="panel-body">
              <img src="{{asset('user/img/150x150.gif')}}" class="img-circle pull-right"> <a href="#">Free @Bootply</a>
  	...
  	<div class="col-sm-6 col-md-4">
          ...
          <div class="well"> 
           ...
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Bootply Editor &amp; Code Library</h4></div>
   			<div class="panel-body">
              <p><img src="{{asset('user/img/150x150.gif')}}" class="img-circle pull-right"> <a href="#">The Bootstrap Playground</a></p>
              <div class="clearfix"></div>
              <hr>
...
the 100% free Bootply.com code repository.
  	...
  	<div class="col-sm-6 col-md-4">
        ...
        <div class="panel panel-default">
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Stackoverflow</h4></div>
   			<div class="panel-body">
              <img src="{{asset('user/img/150x150.gif')}}" class="img-circle pull-right"> <a href="#">Keyword: Bootstrap</a>
              <div class="clearfix"></div>
              <hr>
        ...
        <div class="panel panel-default">
          <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Top Items</h4></div>
   			<div class="panel-body">
              <div class="list-group">
                <a href="#" class="list-group-item active">Bootstrap 3</a>
                <a href="#" class="list-group-item">Snippets</a>
                <a href="#" class="list-group-item">Examples</a>
              </div>
            </div>
   		</div>
    ...
    <div class="col-sm-6 col-md-4">
    	<div class="panel panel-default">
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Upgrade to Bootstrap 3</h4></div>
   			<div class="panel-body">
              <img src="{{asset('user/img/photo.png')}}" class="img-circle pull-right"> <a href="#">Guidance and Tools</a>
              <div class="clearfix"></div>
              <hr>
              <p>Migrating from Bootstrap 2.x to 3 is not a simple matter of swapping out the JS and CSS files.
              Bootstrap 3 is a major overhaul, and there are a lot of changes from Bootstrap 2.x. <a href="#" rel="nofollow">This guidance</a> is intended to help 2.x developers transition to 3.
              </p>
              <h5><a href="#">More on Upgrading from +Bootply</a></h5>
              ...
              <div class="well well-sm">
                <div class="media">
                    <a class="thumbnail pull-left" href="#">
                        <img class="media-object" src="{{asset('user/img/a13ac7aed64918b6354f48da59490e3a.jpg')}}">
                    </a>
     ...
     <div class="col-sm-6 col-md-4">
    	<div class="panel panel-default">
           <div class="panel-heading"><a href="#" class="pull-right">View all</a> <h4>Inspiration</h4></div>
   			<div class="panel-body">
              <img src="{{asset('user/img/150.gif')}}" class="img-circle pull-right"> <a href="#">Articles</a>
              <div class="clearfix"></div>
              <hr>
              <div class="clearfix"></div>
              <img src="{{asset('user/img/FFF_003.gif')}}" class="img-responsive img-thumbnail pull-right">
 ...
 tablets), Medium (for laptops) and Large (for laptops/desktops).</p>
              ...
              <hr>
              <div class="clearfix"></div>
              <img src="{{asset('user/img/FFF_004.gif')}}" class="img-responsive img-thumbnail pull-left" style="margin-right:5px;">
...
creating Web pages.</p>
	...
	<div class="row">
	   ...
	   <div class="col-sm-4 col-xs-6">
        ...
        <div class="panel panel-default">
          <div class="panel-thumbnail"><img src="{{asset('user/img/bg_suburb.jpg')}}" class="img-responsive"></div>
          <div class="panel-body">
            <p class="lead">Hacker News</p>
            <p>120k Followers, 900 Posts</p>
            
            <p>
              <img src="{{asset('user/img/photo_003.jpg')}}" height="28px" width="28px">
              <img src="{{asset('user/img/photo.jpg')}}" height="28px" width="28px">
            </p>
          </div>
        </div>
      ...
      <div class="col-sm-4 col-xs-6">
      	...
      	<div class="panel panel-default">
          <div class="panel-thumbnail"><img src="{{asset('user/img/FFF.gif')}}" class="img-responsive"></div>
          <div class="panel-body">
            <p class="lead">Bootstrap Templates</p>
            <p>902 Followers, 88 Posts</p>
            
            <p>
              <img src="{{asset('user/img/uFp_tsTJboUY7kue5XAsGAs28.png')}}" height="28px" width="28px">
              <img src="{{asset('user/img/photo_002.jpg')}}" height="28px" width="28px">
            </p>
          </div>
        </div>
      ...
      <div class="col-sm-4 col-xs-6">
      	...
      	<div class="panel panel-default">
          <div class="panel-thumbnail"><img src="{{asset('user/img/FFF_002.gif')}}" class="img-responsive"></div>
          <div class="panel-body">
    ...
    <hr>
    <div class="col-md-12 text-center"><p><a href="#" target="_ext">Download Google Plus Style Template</a><br><a href="#" target="_ext">More Bootstrap Templates by @Bootply</a></p></div>
    <hr>
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="col-md-12 text-center">
            <a href="#">This Bootstrap Template</a><br>was made with <i class="glyphicon glyphicon-heart"></i> by <a href="#">Bootply</a>
            <br><br>
