        ...
        <div class="row">
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
              ...
              <a href="{{route('admin.listproducts')}}" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div><!-- ./col -->
          <div class="col-lg-3 col-xs-6">
            <!-- small box -->
            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content no-padding">
               ...
               <div class="box box-success">
                ...
                <h3 class="box-title text-aqua">Market averages</h3>
              </div>
              <div class="box-body" style="padding:3px">
              <canvas id="miller"></canvas>
             </div>
          </div>
            <!-- quick email widget -->
